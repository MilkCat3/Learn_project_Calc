...
################################################################################
## Form generated from reading UI file 'design_calcuta.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(302, 467)
        icon = QIcon()
        icon.addFile(u":/icons/icons/calculate_24dp_000000_FILL1_wght400_GRAD0_opsz24.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        self.lbl_temp.setCursor(QCursor(Qt.PointingHandCursor))
...
"border: none;")
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/icons/backspace_24dp_FFFFFF_FILL1_wght400_GRAD0_opsz24.png", QSize(), QIcon.Normal, QIcon.Off)
